	...
	<view>
		<div class="list-item" v-for="item in list">
			<div class="column list-block">
				...
				<div class="list-info">
					<span class="list-text-add" v-if="item.mode==1">+{{item.money}}</span>
					<span class="list-text-reduce" v-if="item.mode==2">-{{item.money}}</span>
...
<script setup>
	...
	function getList(){
		...
		request('UserBill',searchData.value).then(res=>{
